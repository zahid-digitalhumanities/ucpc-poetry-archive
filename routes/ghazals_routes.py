...
def share_image(text_id):
    ...
    # Use absolute path from current working directory (works on Render)
    ...
    # Save image (ensure it's not empty)
    img.save(filepath, 'PNG')
    print(f"✅ Image saved: {filepath} (size: {os.path.getsize(filepath)} bytes)")
